...
val storyCombinedSteps = listOf(
    StoryStep(
        ...
        "ROSA",
        "Quería soñar con salir a pasear, ir por el jardín y también caminar, " + "pero le faltaba su patita rosa en forma de corazón para avanzar.\n\n" + "¿Dónde está la patita rosa?"
    ), StoryStep(
        "CELESTE",
        ...
        "VERDE",
        "Ya podía caminar, pero quería correr y sentir el viento sin retroceder; " + "así que buscó su patita verde con un triángulo para poner.\n\n" + "¿Dónde está la patita verde?"
    ), StoryStep(
        "NARANJA",
