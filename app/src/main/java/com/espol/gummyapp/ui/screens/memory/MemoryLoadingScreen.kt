...
@Composable
fun MemoryLoadingScreen(
    sequence: List<MemoryPiece>,
    bleResponse: String?,
    ...
    LaunchedEffect(bleResponse) {
        ...
        if (!finished && completedCount == sequence.size) {
            ...
            onFinish(errorCount, durationSeconds)
        }
    }
        ...
        Column(
            ...
            Column(
                ...
                Row(
                    ...
                    sequence.forEachIndexed { index, piece ->
                        Image(
                            painter = painterResource(id = piece.iconRes),
                            contentDescription = piece.name,
                            modifier = Modifier
                                .size(48.dp)
                                .alpha(if (index < completedCount) 1f else 0.25f)
                        )
                    }
                }
